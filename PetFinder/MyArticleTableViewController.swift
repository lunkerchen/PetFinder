...
class MyArticleTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("ZZZZZZZZZZZZZZZ\(articleInfo.myArticle.count)")
    ...
    func loadMyArticle(){
        ...
        if articleInfo.articleList.count != 0{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        label4.text = (self.articleInfo.fireUploadDic?[articleInfo.myArticle[indexPath.row]])?["addTime"] as? String
...
//            print("該檔案不存在，下載檔案")
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        articleInfo.selectMyArticleRow = indexPath.row
        performSegue(withIdentifier: "toMyArticleDetailVC", sender: nil)
    }
